...
const Footer = () => {
  return (
    <footer className="border-t border-t-gray-200 dark:border-t-gray-700 py-8 bg-white dark:bg-[#181829] text-gray-900 dark:text-gray-200">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <h2 className="text-xl font-bold text-gray-900 dark:text-white">CareerHub</h2>
            <p className="text-sm text-gray-700 dark:text-gray-300">© 2024 CareerHub. All rights reserved.</p>
          </div>
          
          <div className="flex space-x-4 mt-4 md:mt-0">
            <a href="https://facebook.com" className="hover:text-[#A084E8]" aria-label="Facebook">
            ...
            <a href="https://twitter.com" className="hover:text-[#A084E8]" aria-label="Twitter">
            ...
            <a href="https://linkedin.com" className="hover:text-[#A084E8]" aria-label="LinkedIn">
